...
namespace GaleriaCarro
{
       ...
       
    {
        ...
        public static void Menu()
        {
            ...
            while (iniciararmazenamento)
            {
                ...
                switch (opcaoarmazenar)
                {
                    ...
                    default:
                        Console.WriteLine("Não existe esta opão ...");
                        break;
        ...
        public static void IncluirCarro()
        {
            ...
            Console.WriteLine("Digite se este carro é lançamento:\n [S] Sim \n [N] Não");
        ...
        private static void MostrarTodos()
        {
            ...
            {
                Console.WriteLine("Essas são as entidades cadastradas...");
            ...
            {
                Console.WriteLine("Ainda não existe entidades cadastradas, favor cadastrar...");
            }
        }
        ...
        {
            Console.WriteLine("Digite o Modelo do carro que deseja encontrar:");
